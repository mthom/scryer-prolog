...
To build a Windows Installer, you'll need first Scryer Prolog compiled in release mode, then, with the WiX Toolset installed, execute:
```
...
To install the WiX Toolset, execute:
```
