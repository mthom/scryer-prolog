...
impl MachineState {
    ...
    pub(super) fn verify_attr_interrupt(&mut self, p: usize, arity: usize) {
        ...
        and_frame[arity + 1] = fixnum_as_cell!(Fixnum::build_with_unchecked(self.b0 as i64));
        and_frame[arity + 2] =
            fixnum_as_cell!(Fixnum::build_with_unchecked(self.num_of_args as i64));
        and_frame[arity + 3] =
            fixnum_as_cell!(Fixnum::build_with_unchecked(self.attr_var_init.cp as i64));
